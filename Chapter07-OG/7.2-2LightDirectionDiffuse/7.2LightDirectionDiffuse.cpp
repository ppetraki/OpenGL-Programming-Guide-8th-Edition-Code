...
void init()
{
	ShaderInfo si[] = { { GL_VERTEX_SHADER, "LightDirectionDiffuse.v" },{ GL_FRAGMENT_SHADER, "LightDirectionDiffuse.g" },{ GL_NONE, "" } };
...
void display()
{
	...
	vmath::vec3 LightColor(0.6, 0.6, 0.6);
	vmath::vec3 LightDirection(0.0, 0.0, 1.0);
